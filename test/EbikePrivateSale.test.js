...
contract("EbikePrivateSale", function ([owner, investor, wallet, purchaser, authorized, unauthorized, anotherAuthorized]) {
    ...
    describe('whitelisting feature', function () {
        describe('single user whitelist', function () {
            ...
            describe('accepting payments', function () {
                ...
                // })
                // it('should correctly report whitelisted address', async function () {
